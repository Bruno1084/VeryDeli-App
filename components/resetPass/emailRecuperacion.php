            ...
            <form class="formulario-recuperacion" action="../../utils/resetPass/validarEmail.php" method="post">
                <div class="row justify-content-center">
                    <div class="form-group col-md-6 mb-3">
                        ...
                        <input type="email" class="form-control bg-input" id="correo" name="correo" required placeholder="Ingrese su correo electronico">
                    </div>
                </div>

                <div class="row justify-content-center my-3">
                    <div class="col-8 col-md-5 text-center">
                        <button type="submit" class="btn btn-morado btn-block">Recuperar</button>
                    </div>
                </div>
            </form>
        </div>
