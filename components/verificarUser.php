                    ...
                    <div class="col-12 VerificacionCard">
                        ...
                        <div class="id-section">
                            ...
                            <div class="button-section">
                                ...
                                <button type="button" class="btn btn-accept" title="Aceptar"  data-id="<?php $verificacionid ?>" data-name="<?php echo $usuarioid;?>" onclick="cambiarEstadoVerificacion(this,1)">Aceptar</button>
                                <button type="button" class="btn btn-reject" title="Rechazar" data-id="<?php $verificacionid ?>" onclick="cambiarEstadoVerificacion(this,2)">Rechazar</button>
                            </div>
                        </div>
                    </div>
                </form> 
