          ...
          <form action="/utils/ControlFormPublicacion.php" class="form-publicacion needs-validation FormularioAjax" novalidate method="post" id="formPublicacion" autocomplete="off" onsubmit="return validarPublicacion()">
            ...
            <div class="row cuerpo_medio mb-4">
              ...
              <div class="col-6" id="lado">
                ...
                <div class="col-md-6">
                  <div class="col-10">
                    <input type="number" step="0.01" class="form-control" id="publicacion-volumen" name="volumen" placeholder="Volumen m³">
                ...
                <div class="col-md-6">
                  <div class="col-10">
                    <input type="number" step="0.01" class="form-control" id="publicacion-peso" name="peso" placeholder="Peso Kg">
              ...
              <div class="col-6 divMapa_Boton">
                ...
                <div class="col-12" style="height: 21px;">
                  <div class="invalid-feedback" id="invalid-map"></div>
                </div>
              </div>
            ...
            <div class="row">
              <div id="add" class="col-12 mb-3">
                ...
                <div class="custom-file-upload mb-2">
                  <h2 id="addPhoto">Cargar Fotos ➕</h2>
                </div>
